...
If \inline{edgeCount} does not equal \inline{numNodes-1} at the end, then a single MST doesn't exist (there may be no MST, or there may be multiple MSTs that contain only part of the graph.
