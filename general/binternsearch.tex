...
Binary search for the last \inline{true} value. The answer is at \inline{lo-1}. To search for the first \inline{true}, negate the if-statement, and the answer will be at \inline{lo}. 
