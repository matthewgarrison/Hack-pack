...
If you have \inline{x} and \inline{y}, and you know \inline{x} is guaranteed to be less than \inline{n}, then you can set \inline{newCoord = y * n + x;}. From that, you can then work backwords: \inline{x = newCoord \% n;} and \inline{y = newCord / n;}.
...
\begin{itemize}
    ...
    \item In main, the only thing should be \inline{new Thread(null, new ClassName(), "", \\ stackSize).start();}
\end{itemize}
